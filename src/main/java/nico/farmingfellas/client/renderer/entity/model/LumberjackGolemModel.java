...
public class LumberjackGolemModel<T extends LumberjackFellaEntity> extends EntityModel<T> implements ModelWithHead, ModelWithArms {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r1 = beanie.addChild("cube_r1", ModelPartBuilder.create().uv(0, 45).cuboid(-2.5F, -3.0F, -1.5F, 6.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(-1, 44).cuboid(-3.0F, -2.0F, -2.0F, 7.0F, 2.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-0.5F, -2.0F, -0.75F, -0.4363F, 0.0F, 0.0F));
