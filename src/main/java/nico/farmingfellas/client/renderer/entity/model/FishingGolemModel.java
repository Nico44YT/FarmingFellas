...
public class FishingGolemModel<T extends FishingFellaEntity> extends AbstractGolemModel<T> {

    public FishingGolemModel(ModelPart root) {
        super(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hat = head.addChild("hat", ModelPartBuilder.create().uv(0, 45).cuboid(-3.0F, -4.0F, -2.0F, 6.0F, 1.0F, 4.0F, new Dilation(0.0F))
                .uv(20, 45).cuboid(-3.0F, -3.5F, -2.0F, 6.0F, 1.0F, 4.0F, new Dilation(0.1F))
                .uv(-7, 51).cuboid(-4.0F, -2.4F, -3.5F, 8.0F, 0.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData left_leg = main.addChild("left_leg", ModelPartBuilder.create().uv(20, 13).cuboid(-1.5F, 0.5F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F))
                .uv(32, 13).cuboid(-1.5F, 0.5F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.1F)), ModelTransform.pivot(2.0F, -3.5F, 0.0F));

        ModelPartData right_leg = main.addChild("right_leg", ModelPartBuilder.create().uv(18, 21).cuboid(-1.5F, 0.5F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F))
                .uv(30, 21).cuboid(-1.5F, 0.5F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.1F)), ModelTransform.pivot(-2.0F, -3.5F, 0.0F));
