...
public class ModItems {
    ...
    public static final Item FISHING_GOLEM_ITEM = register("fishing_golem", new Item.Settings(), $ -> new GolemItem($, world -> new FishingFellaEntity(ModEntities.FISHING_GOLEM, world)));
