...
public class ModBlocks {
    ...
    public static final Block FERTILIZED_FARMLAND = register("fertilized_farmland", AbstractBlock.Settings.copy(Blocks.FARMLAND), FertilizedFarmlandBlock::new, new Item.Settings());
